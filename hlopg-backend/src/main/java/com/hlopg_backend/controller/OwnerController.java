...
public class OwnerController {
    ...
    // ===================== (FUTURE) GET OWNER PGs =====================
    // When you uncomment this, it is already JWT-safe
    /*
    @GetMapping("/pgs")
    public ResponseEntity<?> getOwnerPGs(@RequestHeader("Authorization") String authHeader) {
        try {
            ...
            if (ownerOpt.isEmpty()) {
                return ResponseEntity.badRequest()
                        .body(createErrorResponse("Owner not found"));
            }
    ...
    */
    ...
    // ===================== REMOVE LEGACY TOKEN PARSER =====================
    // ❌ Old extractOwnerIdFromToken removed completely

    // ===================== TEST DATA METHODS (UNCHANGED) =====================
    // private List<Map<String, Object>> getTestPGsData() {
    //     List<Map<String, Object>> testPGs = new ArrayList<>();
    //     return testPGs;
    // }
